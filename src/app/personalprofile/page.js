...
const SkillsFormMobile = () => {
  return (
    <div className="bg-white p-4 rounded shadow-md w-full">
      ...
      <h2 className="text-[22px] text-[#444444] font-semibold mb-1">Let&apos;s know your major skills</h2>
      ...
      <h2 className="text-[22px] text-[#444444] font-semibold mt-6 mb-1">Tell us about Yourself</h2>
