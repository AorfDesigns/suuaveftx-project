...
const ClientsOffer = () => {
  return (
    <div>
      <Card className="p-6">
        <CardHeader className=" flex items-center justify-center text-2xl font-semibold">Client's Profile</CardHeader>
        <CardBody className="flex flex-col items-center justify-center text-center space-y-3">
          {/* Client Image */}
          <Image src={"/dev-images/Clients.png"} width={150} height={150} alt="Clients-image" />
          ...
          <div className="flex gap-2 items-center">
            ...
            <Image src={"/dev-images/ratings.png"} width={60} height={60} alt="ratings" />
          </div>
